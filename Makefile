...
FLAGS 					= -O2 -std=c++17 -Wall -g -DVK_USE_PLATFORM_WIN32_KHR -DUF_USE_VULKAN -DGLM_ENABLE_EXPERIMENTAL -DUF_USE_JSON -DUF_USE_NCURSES -DUF_USE_OPENAL -DUF_USE_VORBIS -DUF_USE_FREETYPE
#-march=native
LIB_NAME 				= uf
EXT_LIB_NAME 			= ext
...
WIN64_DEPS 				= -lgdi32 -lvulkan-1 -lpng -lz -lassimp -ljsoncpp -lopenal32 -lalut -lvorbis -lvorbisfile -logg -lfreetype -lncursesw -lcurl -ldiscord_game_sdk
