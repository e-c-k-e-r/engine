...
void ext::vulkan::ComputeGraphic::createCommandBuffer( VkCommandBuffer commandBuffer, uint32_t pass ) {
...
void ext::vulkan::RTGraphic::createCommandBuffer( VkCommandBuffer commandBuffer, uint32_t pass ) {
