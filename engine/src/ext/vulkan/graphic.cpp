...
void ext::vulkan::Graphic::initializeDescriptorLayout( const std::vector<VkDescriptorSetLayoutBinding>& setLayoutBindings ) {
...
/*
	VkPushConstantRange pushConstantRange = ext::vulkan::initializers::pushConstantRange(
...
void ext::vulkan::Graphic::createCommandBuffer( VkCommandBuffer commandBuffer, uint32_t pass  ) {
}
