...
std::unordered_map<uf::typeInfo::index_t, pod::TypeInfo>* uf::typeInfo::types = NULL;
void uf::typeInfo::registerType( const index_t& index, size_t size, const std::string& pretty ) {
	if ( !uf::typeInfo::types ) uf::typeInfo::types = new std::unordered_map<uf::typeInfo::index_t, pod::TypeInfo>;
