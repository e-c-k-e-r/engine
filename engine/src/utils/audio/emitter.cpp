...
uf::Audio& UF_API uf::SoundEmitter::load( const std::string& filename ) {
//	if ( this->has(filename) ) return this->get(filename);
	uf::Audio& sound = this->add();
	sound.load(filename);
	return sound;
}
uf::Audio& UF_API uf::SoundEmitter::stream( const std::string& filename ) {
//	if ( this->has(filename) ) return this->get(filename);
	uf::Audio& sound = this->add();
...
uf::Audio& UF_API uf::MappedSoundEmitter::load( const std::string& filename ) {
	if ( this->has(filename) ) return this->get(filename);
...
uf::Audio& UF_API uf::MappedSoundEmitter::stream( const std::string& filename ) {
	if ( this->has(filename) ) return this->get(filename);
