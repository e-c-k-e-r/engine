...
// 	Initializes POD
uf::PointeredUserdata::PointeredUserdata(std::size_t len, void* data) {
	if ( len && data ) this->create(len, data);
}

// Initializes from POD
uf::PointeredUserdata::PointeredUserdata( const pod::PointeredUserdata& pointer ) : m_pod(pointer) {

}

// Move c-tor
uf::PointeredUserdata::PointeredUserdata( PointeredUserdata&& move ) :
...
// 	D-tor
uf::PointeredUserdata::~PointeredUserdata() {
	this->destroy();
}
// 	Destroys the POD
