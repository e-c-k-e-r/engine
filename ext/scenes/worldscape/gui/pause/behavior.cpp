...
namespace {
	void playSound( uf::Object& entity, const std::string& key ) {
...
EXT_BEHAVIOR_REGISTER_CPP(GuiWorldPauseMenuBehavior)
EXT_BEHAVIOR_REGISTER_AS_OBJECT(GuiWorldPauseMenuBehavior, GuiWorldPauseMenu)
#define this (&self)
void ext::GuiWorldPauseMenuBehavior::initialize( uf::Object& self ) {
	uf::Scene& scene = uf::scene::getCurrentScene();
	uf::Serializer& masterdata = scene.getComponent<uf::Serializer>();
	...
	// opened
	playSound(self, "menu open");

	/* Magic Circle Outter */ {
	//	circleOut = (uf::Object*) this->findByUid(this->loadChildUid("./circle-out.json", true));
		circleOut = (uf::Object*) this->loadChildPointer("./circle-out.json", true);
	/*
	...
	*/
	...
	//	circleIn = (uf::Object*) this->findByUid(this->loadChildUid("./circle-in.json", true));
		circleIn = (uf::Object*) this->loadChildPointer("./circle-in.json", true);
	/*
	...
	*/
	...
	//	mainText = (uf::Object*) this->findByUid(this->loadChildUid("./main-text.json", true));
		mainText = (uf::Object*) this->loadChildPointer("./main-text.json", true);
	/*
	...
	*/
	...
	//	commandText = (uf::Object*) this->findByUid(this->loadChildUid("./command-text.json", true));
		commandText = (uf::Object*) this->loadChildPointer("./command-text.json", true);
	/*
	...
	*/
	...
	//	coverBar = (uf::Object*) this->findByUid(this->loadChildUid("./yellow-box.json", true));
		coverBar = (uf::Object*) this->loadChildPointer("./yellow-box.json", true);
	/*
	...
	*/
	...
	//	tenkouseiOption = (uf::Object*) this->findByUid(this->loadChildUid("./tenkousei.json", true));
		tenkouseiOption = (uf::Object*) this->loadChildPointer("./tenkousei.json", true);
	/*
	...
	*/
	...
	//	closeOption = (uf::Object*) this->findByUid(this->loadChildUid("./close.json", true));
		closeOption = (uf::Object*) this->loadChildPointer("./close.json", true);
	/*
	...
	*/
	...
	//	quitOption = (uf::Object*) this->findByUid(this->loadChildUid("./quit.json", true));
		quitOption = (uf::Object*) this->loadChildPointer("./quit.json", true);
	/*
...
void ext::GuiWorldPauseMenuBehavior::tick( uf::Object& self ) {
...
void ext::GuiWorldPauseMenuBehavior::render( uf::Object& self ){}
void ext::GuiWorldPauseMenuBehavior::destroy( uf::Object& self ){}
#undef this